...
export const DatingNavigation = () => {
    return (
        <DatingStack.Navigator initialRouteName='Main'>
                <DatingStack.Screen name="Main" component={DatingListScreen} options={{ headerShown: false }} />
                <DatingStack.Screen name="Profile" component={DatingProfileScreen} options={{ headerShown: false }} />
