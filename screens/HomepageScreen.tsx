...
export const HomepageScreen: FC<HomepageScreenProps> = ({ navigation }) => {
    ...
    return (
              <Flex flex = {1} bg="white">
                { showChecklist ? (<Flex py={2} flex = {1 } minHeight="120">
                ...
                <IconButton mt="auto" position="absolute" variant="solid" rounded="full" size="lg" top={height - .3*height} right ={5} onPress={onOpenPostModal} icon={<Icon as = {AntDesign} name = "plus" />} />
                </Flex>
