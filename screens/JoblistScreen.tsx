...
const EmtpyJobList: FC = ()=>{
    return (
        <Flex p={5} flex={1} justifyContent="center" alignItems="center" my={2} borderWidth={1} borderColor="primary.300">
            <Heading mb={2}>No Job or Business Yet 💼</Heading>
            <Text lineHeight="xl">Watch out on this space for jobs you can apply for in across different locations in Nigeria.
                You can also post your own buisness or service for people to find you
            </Text>
