...
type ProfileReviewScreenProps = NativeStackScreenProps<HomeStackParamList, "ProfilePreview">



export const ProfileReviewScreen : FC<ProfileReviewScreenProps> = ({navigation, route}) =>{
